...
## Canonical register
- Decision and backlog source: `docs/decision-backlog-register.md`.

## Immediate priorities
1. Stabilize pre-launch guardrails and beta charter.
2. Implement invitations evolution (friend-first + optional group invite) in phased rollout.
...
- Do not auto-add invited users as residents without explicit group invitation scope.
