DROP FUNCTION IF EXISTS public.get_my_p2p_balances(uuid);
...
REVOKE ALL ON FUNCTION public.get_my_p2p_balances() FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.get_my_p2p_balances() TO authenticated;
