      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        {isMobileViewport && menuOpen && (
          <>
            ...
            />
            <div className="absolute bottom-0 left-0 top-16 z-40 w-[18rem] max-w-[calc(100vw-2rem)] overflow-y-auto border-r border-sidebar-border bg-sidebar text-sidebar-foreground shadow-2xl animate-in slide-in-from-left duration-300">
              <SidebarContent />
            </div>
          </>
        )}
