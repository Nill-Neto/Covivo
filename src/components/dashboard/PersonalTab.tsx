    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold tracking-tight">R$ {myCollectiveShare.toFixed(2)}</div>
        ...
        <Card className={`${totalIndividualPending > 0 ? "border-warning/50 bg-warning/5" : ""}`}>
          ...
          <CardContent>
            <div className={`text-2xl font-bold tracking-tight ${totalIndividualPending > 0 ? "text-warning-foreground" : ""}`}>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold tracking-tight">R$ {totalBill.toFixed(2)}</div>
